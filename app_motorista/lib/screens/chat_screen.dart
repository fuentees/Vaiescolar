...
/// escuta novas mensagens ao vivo via WebSocket.
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  void _connectSocket() {
    _socket.connect(token: Api.token!, parentUserId: widget.parentUserId);
  ...
  Future<void> _send() async {
    ...
    _scrollToBottom();
    final ok = await Api.sendChatMessage(widget.parentUserId, text);
    setState(() {
  ...
  Future<void> _retry(_Msg msg) async {
    ...
    final ok = await Api.sendChatMessage(widget.parentUserId, msg.body);
      ...
      body: Column(
        children: [
          Container(
            ...
            child: Text(
              'Este chat nao e um canal de emergencia.',
              style: Theme.of(context).textTheme.bodySmall,
